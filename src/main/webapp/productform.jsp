                            ...
                            <div class="card-body p-4 p-lg-5 text-black">
                                ...
                                <form  action="ProductServlet" method="post">
                                    ...
                                    <div class="form-outline mb-2">
                                        <label>Enter Id</label> <input class="form-control form-control-lg" type="text" name="id" required />
                                    </div>
                                    <div class="form-outline mb-2">
                                        <label>Enter Name</label> <input class="form-control form-control-lg" type="text" name="name" required />
                                    </div>
                                    ...
                                    <div class="form-outline mb-4">
                                        <label>Quantity</label> <input class="form-control form-control-lg" type="number" name="quantity" required/>
                                    </div>
                                    <div class="pt-1 mb-4">
                                        <label>Product Category</label> <input class="form-control" type="text" name="product_category" required/>
                                    </div>
<%--                                    <div class="pt-1 mb-4">--%>
